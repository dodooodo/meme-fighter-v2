...
func _test_character_and_movement_data() -> void:
    ...
    t.equal(zone.max_hp, 1000, "Zone HP")
...
func _test_zone_normals_and_throw_runtime() -> void:
    ...
    t.equal(light.fighter_b.combatant.hp, 952, "Zone Light actual simulation deals 48")
    ...
    t.equal(heavy.fighter_b.combatant.hp, 900, "Zone Heavy actual simulation deals 100")
    ...
    t.equal(low.fighter_b.combatant.hp, 942, "Zone Low actual simulation deals 58")
    ...
    t.equal(throw_battle.fighter_b.combatant.hp, 890, "Zone Forward+Heavy actual throw deals 110")
